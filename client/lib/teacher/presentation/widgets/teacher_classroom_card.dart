...
class TeacherClassroomCard extends StatelessWidget {
  final String classroomName, numberOfStudents;
  final Function deleteClassroomCallback;

  const TeacherClassroomCard({super.key,required this.classroomName,required this.numberOfStudents,required this.deleteClassroomCallback});
