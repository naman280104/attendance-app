...
class _StudentProfileState extends State<StudentProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController rollNumberController = TextEditingController(text: "");
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String,dynamic>>(
        future: StudentProfileService.getProfileDetials(context),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if(initial){
              ...
              rollNumberController = TextEditingController(text: profileData['roll_no']);
